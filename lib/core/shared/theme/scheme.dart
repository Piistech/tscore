...
class ThemeScheme {
  ...
  factory ThemeScheme.find({
    ...
    final theme = ThemeScheme(
      ...
      warning: const Color.fromARGB(207, 255, 221, 0),
      willLive: const Color.fromARGB(232, 254, 147, 24),
      tomorrow: const Color.fromARGB(255, 254, 170, 251),
